<template>
  <div id="app-container">
    <nav class="navbar">
      <div class="nav-brand">🚀 DeployTrack</div>
      <div class="nav-links">
...
.btn { padding: 0.5rem 1.2rem; border: none; border-radius: 6px; cursor: pointer; font-size: 0.9rem; font-weight: 500; transition: opacity 0.2s; }
